...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-[#d2d2d7]/50 z-50">
      <div className="max-w-lg mx-auto px-2 pb-[max(env(safe-area-inset-bottom),8px)]">
